...
def AngularSpectrumDiffraction(Ex0, Ey0, wavelennum, samplenum, Dx, wavelen0, lam):
    ...
    filename = 'E:\\huangbaoze\\python\\total_optical_field\\otherwavelengths_verification\\DBS_(13)_28_19_10_(20000)\\ZItotalDisplay\\' + 'ZItotalDisplay' + str(wavelennum) + '.xlsx'
...
def computing_plot(Z, AllDisplay, wavelennum, Num, nn, Dx, wavelen0, lam, ItotalDisplay_incident, ItotalDisplaymax):
    ...
    file4 = 'E:\\huangbaoze\\python\\total_optical_field\\otherwavelengths_verification\\DBS_(13)_28_19_10_(20000)\\' + 'ZItotalDisplay_SideLobe_Imax_SL_ItotalDisplay_all.xlsx'
