...
class PropagationPlot:
    ...
    def run(self, flag):
        ...
        for i in range(self.lamnum):
            ...
            file1 = 'E:\\huangbaoze\\python\\total_optical_field\\otherwavelengths_verification\\DBS_(13)_28_19_10_(20000)\\' + 'DL_FWHM_f_FL_Ipeak.xlsx'
        ...
        file2 = 'E:\\huangbaoze\\python\\total_optical_field\\otherwavelengths_verification\\DBS_(13)_28_19_10_(20000)\\' + 'min_matrixband.xlsx'
        df2 = pd.DataFrame(matrixband[18].get())
