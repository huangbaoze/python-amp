...
def AngularSpectrumDiffraction(Ex0, Ey0, wavelennum, samplenum, Dx, wavelen0, lam):
    ...
    Num = 571
    # Zd1 = np.arange(210, 560 + 1, 1) * wavelen0
    ...
    filename = 'E:\\huangbaoze\\python\\A_gdgddfold\\otherwavelengths_verification\\3_random_3(n=2)\\ZItotalDisplay\\' + 'ZItotalDisplay' + str(wavelennum) + '.xlsx'
...
def computing_plot(Z, AllDisplay, wavelennum, Num, nn, Dx, wavelen0, lam, ItotalDisplay_incident, ItotalDisplaymax):
    ...
    file4 = 'E:\\huangbaoze\\python\\A_gdgddfold\\otherwavelengths_verification\\3_random_3(n=2)\\' + 'ZItotalDisplay_SideLobe_Imax_SL_ItotalDisplay_all.xlsx'
