...
def AngularSpectrumDiffraction(Ex0, Ey0, wavelennum, samplenum, Dx, wavelen0, lam, filenum):
    ...
    filename = 'D:\\zhaofen\\huangbaoze\\A_gdgddfold\\total_optical_field\\otherwavelengths_verification\\fold_random_' + str(filenum) +'\\ZItotalDisplay\\' + 'ZItotalDisplay' + str(wavelennum) + '.xlsx'
...
def computing_plot(Z, AllDisplay, wavelennum, Num, nn, Dx, wavelen0, lam, ItotalDisplay_incident, ItotalDisplaymax, filenum):
    ...
    file4 = 'D:\\zhaofen\\huangbaoze\\A_gdgddfold\\total_optical_field\\otherwavelengths_verification\\fold_random_' + str(filenum) + '\\ZItotalDisplay_SideLobe_Imax_SL_ItotalDisplay_all.xlsx'
