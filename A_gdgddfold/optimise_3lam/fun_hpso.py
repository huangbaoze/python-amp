...
def Fun_diffraction(phi, matrixband, matrixPhaseBandGap, wavelennum, samplenum, Dx, T, N, bandnum, wavelen0, lam, f):
    ...
    ratio1, distance1, strength1, SL, efficiency = AngularSpectrumDiffraction(Ex0, Ey0, wavelennum, samplenum, Dx, wavelen0, lam, f)
...
def AngularSpectrumDiffraction(Ex0, Ey0, wavelennum, samplenum, Dx, wavelen0, lam, f):
    ...
    # if wavelennum == 27:
    #     Zd1 = np.arange(255, 305 + 0.5, 0.5)*wavelen0
    # if wavelennum == 14:
    #     Zd1 = np.arange(340, 390 + 0.5, 0.5)*wavelen0
    # if wavelennum == 3:
    #     Zd1 = np.arange(443, 493 + 0.5, 0.5) * wavelen0
