...
class gd_gdd_fold:
    ...
    def run(self):
        ...
        df_fold_GD.to_excel('df_fold_GD.xlsx', sheet_name='Sheet1', startrow=0, header=False, index=False)
        df_fold_GDD.to_excel('df_fold_GDD.xlsx', sheet_name='Sheet1', startrow=0, header=False, index=False)
        df_fold_phase.to_excel('df_fold_phase.xlsx', sheet_name='Sheet1', startrow=0, header=False, index=False)
        print(lac_num1.get())
        ...
        for l in range(self.populationall):
            ...
            for j in range(num):
                ...
                ratio1, distance1, strength1, SL, efficiency = Fun_diffraction(
                    ...
                    self.N, self.bandnum, self.lamc, self.lam)
                ...
                print(strength1)
                print(j)
                data = np.array([[DLWavelen[0], ratio1[0], self.f[int(lamnum[j] - 1)] / self.lamc, distance1[0],
