...
def AngularSpectrumDiffraction(Ex0, Ey0, wavelennum, samplenum, Dx, wavelen0, lam):
    ...
    filename = 'E:\\huangbaoze\\python\\A_gdgddfold\\fold_total_field_3lam\\otherwavelengths_verification\\fold_random_4\\ZItotalDisplay\\' + 'ZItotalDisplay' + str(wavelennum) + '.xlsx'
...
def computing_plot(Z, AllDisplay, wavelennum, Num, nn, Dx, wavelen0, lam, ItotalDisplay_incident, ItotalDisplaymax):
    ...
    file4 = 'E:\\huangbaoze\\python\\A_gdgddfold\\fold_total_field_3lam\\otherwavelengths_verification\\fold_random_4\\' + 'ZItotalDisplay_SideLobe_Imax_SL_ItotalDisplay_all.xlsx'
